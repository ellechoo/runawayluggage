...
//old environment placement
  ...
  class CreateParticles {
    ...
    onMouseDown(event) {
      ...
      // Assuming this.particles is already created in createText()
    ...
    render() {
      ...
      if (intersects.length > 0 && this.particles) {
        const pos = this.particles.geometry.attributes.position;
  ...
  // Shader code provided in the HTML via separate <script> tags should remain as is.
  // For reference, here are the shaders as they appear (if needed):
